...
export default function QrCodeCard({ qrCode }: any) {
	return (
		<Link
			...
			key={qrCode.id}
			className="flex flex-row gap-3 bg-gray-100 py-3 px-6 w-full rounded-xl shadow-md items-center justify-between hover:bg-gray-200"
		>
			<div className="flex flex-col gap-2">
				{qrCode.imageUrl && (
					<img src={qrCode.imageUrl} alt={qrCode.title} className="w-[75px] h-fit" />
				)}
